...
// fetch 
export const fetchEcoorderDataData = createAction(
    '[Data] fetch orderDatas'
);
export const fetchEcoorderDataSuccess = createAction(
    '[Data] fetch orderDatas success',
    props<{ orderDatas: OrdersModel[] }>()
)
export const fetchEcoorderDataFail = createAction(
    '[Data] fetch orderDatas failed',
    props<{ error: string }>()
)

//Details Data
export const fetchEcoDetailIdData = createAction(
    '[Data] Get orderDatas details',
    props<{orderIdDetail: any }>()
)
export const fetchEcoDetailIdDataSuccess = createAction(
    '[Data] Get orderDatas details successfully',
    props<{ orderDetailData: any }>()
)
...
//Update Delivery to Order
// export  const updateDelivery =createAction(
//     '[Data] Update Delivery to Order',
//     props
// )
